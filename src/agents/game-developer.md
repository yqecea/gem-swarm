...
color: blue
tools: [read_file, read_many_files, write_file, replace, run_shell_command, grep_search, glob, list_directory, ask_user]
tools.gemini: [read_file, read_many_files, write_file, replace, run_shell_command, grep_search, glob, list_directory, ask_user]
max_turns: 20
temperature: 0.2
timeout_mins: 10
capabilities: full
