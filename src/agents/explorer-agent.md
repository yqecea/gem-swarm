...
color: blue
tools: [read_file, read_many_files, grep_search, glob, run_shell_command, list_directory, ask_user, google_web_search]
tools.gemini: [read_file, read_many_files, grep_search, glob, run_shell_command, list_directory, ask_user, google_web_search]
max_turns: 15
temperature: 0.2
timeout_mins: 10
